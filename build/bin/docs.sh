...
find tmp/demos/demos \( -name '*.html' -o -name '*.php' \) -exec sed -i${SED_INPLACE_EXT} -e "s@_assets/js/\"@_assets/js/$DEMOSNAME.js\"@" {} \;
find tmp/demos/demos -name "*$SED_INPLACE_EXT" -exec rm {} \;
